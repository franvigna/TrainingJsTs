...
const _7_util_js_1 = __importStar(require("./7-util.js"));
var MiSpace;
(function (MiSpace) {
    function saludaNS(name) {
        return `Hola desde namespace, ${name}!`;
    }
    MiSpace.saludaNS = saludaNS;
})(MiSpace || (MiSpace = {}));
// DOM
const out7 = document.getElementById("out-modulos");
document.getElementById("btn-modulo")
    .addEventListener("click", () => {
    out7.textContent = `${(0, _7_util_js_1.saludaModule)("Usuario")}\n${(0, _7_util_js_1.default)()}`;
});
